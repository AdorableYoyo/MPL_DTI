...
def main():
    ...
    parser.add_argument('--runseed',type=int, default=0,help='random weights seed')
    ...
    parser.add_argument('--threshold', default= 0.7, type=float, help='shreshold for confidence of soft pl' ) 
    parser.add_argument('--ratio_low' , default=0.9 ,type=float, help='lower bound of pos and neg ratio')
    parser.add_argument('--ratio_high' , default=1.2 ,type=float, help='upper bound of pos and neg ratio')
